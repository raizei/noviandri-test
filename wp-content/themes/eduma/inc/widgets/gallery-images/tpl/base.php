...
if ( $instance['image'] ) {
	...
	echo '<div class="thim-carousel-wrapper gallery-img ' . $have_color . ' ' . esc_attr( $css_animation ) . '" ' . $number . $item_tablet . $item_mobile . ' data-autoplay="' . esc_attr( $autoplay ) . '" data-navigation="' . esc_attr( $navigation ) . '" data-pagination="' . esc_attr( $pagination ) . '" data-loop="true">';
	$i = 0;
