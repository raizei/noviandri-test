...
function pix_product_add_to_cart_sm_btn_action($post, $product, $nonce, $icon_class = 'text-body-default')  {
	 ...
	 <div class="pix-pl-10 align-self-stretch d-flex">
		 ...
		 if($product->is_type( 'variable' )){
			 ...
			 ?>
			 	<a href="<?php echo esc_attr( $add_link ); ?>" class="pix-add-to-cart <?php echo esc_attr( $icon_class ); ?>" data-product_id="<?php echo esc_attr( $post->ID ); ?>" data-name="<?php echo esc_attr( $product->get_name() );?>" data-img="<?php echo esc_attr( $image ); ?>">
