...
/* ---------------------------------------------------------------------------
 * Promo box [pix_photo_stack] [/pix_photo_stack]
* --------------------------------------------------------------------------- */
		...
		if(!empty($items)){
			...
			foreach ($items as $key => $value) {
				if(!empty($value['image'])){
					...
					// $output .= '<div class="d-inline-block w-100 h-100" '.$jarallax.'>';
					...
					$output .= '<img class="pix-lazy rounded-lg '.$class_names.'" loading="lazy" data-srcset="'.$imgSrcset.'" src="'.PIX_IMG_PLACEHOLDER .'" data-src="'.$imgSrc.'" alt="'. $alt .'" />';
