...
class Pix_Eor_Img_Carousel extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-img-carousel-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/img-carousel.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-img-carousel-handle' ];
	  }
