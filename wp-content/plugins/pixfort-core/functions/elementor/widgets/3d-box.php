...
class Pix_Eor_3d_Box extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-3d-box-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/3d-box.js', [ 'elementor-frontend' ], PLUGIN_VERSION, true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-3d-box-handle' ];
	  }
