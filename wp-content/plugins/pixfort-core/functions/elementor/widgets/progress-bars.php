...
class Pix_Eor_Progress_Bars extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-progress-bars-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/progress-bars.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-progress-bars-handle' ];
	}
