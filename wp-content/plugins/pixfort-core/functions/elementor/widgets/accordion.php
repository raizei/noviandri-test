...
class Pix_Eor_Accordion extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-accordion-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/accordion.js', [ 'elementor-frontend' ], PLUGIN_VERSION, true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-accordion-handle' ];
	  }
