...
class Pix_Eor_Review extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-reviews-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/review.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-reviews-handle' ];
	  }
