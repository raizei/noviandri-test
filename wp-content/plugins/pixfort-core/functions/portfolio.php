...
function pix_portfolio_meta_add(){
	...
	$pix_page_meta_box = array(
		...
		'fields'	=> array(
			...
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Master Slider 2', 'pixfort-core'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pixfort-core'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=masterslider">Master Sliders</a>', 'pixfort-core'),
			...
			// 	'id' 		=> 'pix-post-slider',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Revolution Slider', 'pixfort-core'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pixfort-core'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=revslider">Revolution Sliders</a>', 'pixfort-core'),
			...
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Layer Slider', 'pixfort-core'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pixfort-core'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=layerslider">Layer Sliders</a>', 'pixfort-core'),
			...
			// 	'id' 		=> 'pix-post-menu',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Custom Menu', 'pixfort-core'),
			// 	'options' 	=> $aMenus,
			// ),
			//
			// array(
